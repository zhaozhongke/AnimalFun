...
#define SHKMyAppName			@"Cat Me Lite"
#define APPIRATER_APP_ID		477091713

#define TSArticleTitle           @"Add Cat"
#define SHKMyAppURL				@"http://none.com"

//IAP CONFIG
#define IsAppSupportIAP          YES   //YES or NO

/*
 config as below used for modual  reuse 
*/

#define TSArticle               @"cat"
#define TSFreeIconCount              5
#define TSChargeArticleIconCount    95
#define TSTotalIcons                (TSFreeIconCount+TSChargeArticleIconCount)
...
#define SHKFacebookKey				@"133368003435608"
#define SHKFacebookSecret			@"359b27e9d3c7bbcbb60bd1f694e4ebd8"
 ...
 */
#define SHKTwitterConsumerKey		@"svV45smNx6ekllnxgqaA"
#define SHKTwitterSecret			@"vHHtmdgartFqaMAEyCo9y6RM1r3RDrMJEfrMNzwWoqw"
#define SHKTwitterCallbackUrl		@"http://www.tactsky.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
#define SHKBitLyLogin				@"tactsky"
#define SHKBitLyKey					@"tactsky123"
