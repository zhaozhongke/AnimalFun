...
void filterCartton(UInt8 *pixelBuf, UInt32 offset, void *context)
{	
    int r = offset;
	int g = offset+1;
	int b = offset+2;
...
void filterMemory(UInt8 *pixelBuf, UInt32 offset, void *context)
{	
...
- (UIImage*)cartton
{
	return [self applyFilter:filterCartton context:nil];
}
- (UIImage*)memory
{
	return [self applyFilter:filterMemory context:nil];
}
...
- (UIImage*)lomo: (double)staurate withContrast:(double)contrast
{
	UIImage *image = [[self saturate:staurate] contrast:contrast];
...
- (UIImage*)lomoRED: (double)staurate withContrast:(double)contrast
{
	...
	NSArray *redPoints = [NSArray arrayWithObjects:
                          [NSValue valueWithCGPoint:CGPointMake(0, 0)],
                          [NSValue valueWithCGPoint:CGPointMake(119, 100)],
                          [NSValue valueWithCGPoint:CGPointMake(151, 157)],
						  [NSValue valueWithCGPoint:CGPointMake(212, 216)],
                            [NSValue valueWithCGPoint:CGPointMake(255, 255)],
                          nil];
	NSArray *greenPoints = [NSArray arrayWithObjects:
                            [NSValue valueWithCGPoint:CGPointMake(115, 13)],
                            [NSValue valueWithCGPoint:CGPointMake(115, 117)],
                            [NSValue valueWithCGPoint:CGPointMake(167, 162)],
                            [NSValue valueWithCGPoint:CGPointMake(215, 208)],
                            nil];
	NSArray *bluePoints = [NSArray arrayWithObjects:
                           [NSValue valueWithCGPoint:CGPointMake(30, 28)],
                           [NSValue valueWithCGPoint:CGPointMake(117, 111)],[NSValue valueWithCGPoint:CGPointMake(215, 208)],
                           nil];
	image = [[[image applyCurve:redPoints toChannel:CurveChannelRed] 
			  applyCurve:greenPoints toChannel:CurveChannelGreen]
             applyCurve:bluePoints toChannel:CurveChannelBlue];
...
//    UIImage *mask=[finalImage blurredCopyUsingGuassFactor:5 andPixelRadius:10];
//	UIImage *blurredSelf = [self gaussianBlur:2];
    UIImage *blurredSelf=[finalImage blurredCopyUsingGuassFactor:5 andPixelRadius:2];
